...
class Pagination {
  ...
  public function __construct(
    public int $page = 1, public int $per_page = 1, public int $total = 1,
  ) {
  ...
  public function getHtml(): string {
    ...
    } // if current page is more than to kolichestvo links kotoroe we are supposed to show + 1 (for first page we doesnt need that if-condition to work)
