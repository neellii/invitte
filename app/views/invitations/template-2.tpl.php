...
посвященному нашему бракосочетанию, которое состоится</p>
  ...
  <section class="section programm">
    <div class="timeline-container">
      <img class="cherry02" src="../public/invitations/img/template-2/cherry2.png" alt="art">
  ...
  <section class="dresscode">
    <img class="cherry03" src="../public/invitations/img/template-2/cherry3.png" alt="art">
    <h2>Дресс-код</h2>
  ...
  <section class="hashtag">
    ...
    <img class="cherry04" src="../public/invitations/img/template-2/cherrysingle2.png" alt="art">
  </section>
  <?php endif; ?>
  ...
  <section class="form">
    ...
    <img class="cherry05" src="../public/invitations/img/template-2/cherrysingle3.png" alt="art">
  </section>
  <?php endif; ?>
  ...
  <section class="section timer">
    ...
    <img class="cherry06" src="../public/invitations/img/template-2/cherrysingle1.png" alt="art">
  </section>
  <?php endif; ?>
