<?php require_once VIEWS . '/incs/invitations/header_inv.tpl.php' ?>
 ...
 <main>
  <img class="background" src="../public/invitations/img/template-4/background.png" alt="back">
  <div class="wrapper">
  <div class="preview">
    ...
    <img style="transform: scaleX(-1);" class="preview__star1" src="../public/invitations/img/template-4/stars.png" alt="art">
    <img class="preview__star2" src="../public/invitations/img/template-4/stars.png" alt="art">
  </div>
...
посвященному нашему бракосочетанию, которое состоится</p>
    ...
    <img class="stars01" src="../public/invitations/img/template-4/stars.png" alt="art">
  </div>

  <?php if(array_key_exists('programm_name', $inv_data)): ?>
  <section class="section programm">
    <div class="timeline-container">
      <img class="stars02" src="../public/invitations/img/template-4/stars.png" alt="art">
  ...
  <section class="dresscode">
    <img class="stars03" src="../public/invitations/img/template-4/stars.png" alt="art">
    <h2>Дресс-код</h2>
  ...
  <section class="hashtag">
    ...
    <img class="stars04" src="../public/invitations/img/template-4/stars.png" alt="art">
  </section>
  <?php endif; ?>
  ...
  <section class="form">
    ...
    <img class="stars05" src="../public/invitations/img/template-4/stars.png" alt="art">
  </section>
  <?php endif; ?>
  ...
  <section class="section timer">
    ...
    <img class="stars06" src="../public/invitations/img/template-4/stars.png" alt="art">
  </section>
  <?php endif; ?>
  ...
  <section class="ps">
    ...
    <img class="stars07" src="../public/invitations/img/template-4/stars.png" alt="art">
    <img style="transform: scaleX(-1);" class="stars08" src="../public/invitations/img/template-4/stars.png" alt="art">
  </section>
