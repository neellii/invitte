<?php require_once VIEWS . '/incs/invitations/header_inv.tpl.php' ?>
 ...
 <main>
  <div class="wrapper">
  <div class="preview">
    <img src="../public/invitations/img/template-7/upper_cloud.png" alt="art">
    <img class="couple_img" src="../public/invitations/img/template-7/demo.mp4" alt="newlyweds">
    <div class="wed-names">
      <h1 class="groom_name"><?= $inv_data['groom_name'] ?></h1>
      <h1 class="and">&</h1>
      <h1 class="bride_name"><?= $inv_data['bride_name'] ?></h1>
    </div>
    <img src="../public/invitations/img/template-7/bottom_cloud.png" alt="art">
  </div>
